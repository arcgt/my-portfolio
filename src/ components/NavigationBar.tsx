  ...
  return (
    <>
      <nav className='flex flex-col fixed top-0 left-0 z-[10] h-36 gap-4 w-full items-center justify-center bg-gray-50 shadow-sm'>
        ...
        <div className='flex flex-row items-center gap-16'>
          <Link to="/"><p className='font-light text-gray-950'>Home</p></Link>
          <Link to="/portfolio"><p className='font-light text-gray-950'>Portfolio</p></Link>
          <Link to="/contact"><p className='font-light text-gray-950'>Contact</p></Link>
        </div>
      </nav>
    </>
  );
